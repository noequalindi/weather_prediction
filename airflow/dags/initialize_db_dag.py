...
from sqlalchemy import create_engine, MetaData, Table, Column, Integer, String, Float, Date, TIMESTAMP, DateTime, inspect
...
dag = DAG(
    'create_and_load_tables_postgres_train_model',
...
#     schedule_interval=timedelta(minutes=8),  # Ejecutar cada 8 min 
#     start_date=datetime(2024, 6, 24),  # Iniciar inmediatamente al iniciar la app
...
create_tables_task >> init_minio_task >> load_csv_task >> upload_csv_task >> train_rf_task 
